...
//	@GetMapping("/operePerAutore")
//	public String getOperePerAutore(Model model) {
//		model.addAttribute("opere", this.operaService.findByAutore(nomeAutore));
//		return "listaOperePerAutore";
//	}
